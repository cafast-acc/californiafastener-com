      ...
      <section className="cnc-hero">
        <div className="cnc-hero-content">
          ...
          <div className="cnc-hero-image">
            <Img
              src="/assets/photos/cnc-livetooling-lathe.jpg"
              alt="CNC lathe"
            />
          </div>
      ...
      <section className="industries">
        ...
        <div className="industry-grid">
          <IndustryTile
            ...
            img="/assets/photos/construction.webp"
          />
          <IndustryTile
            ...
            img="/assets/photos/industrial-170240857.webp"
          />
          <IndustryTile
            ...
            img="/assets/photos/infrastructure-753784784.webp"
          />
          <IndustryTile
            ...
            img="/assets/photos/manufacturing-731342733.jpg"
          />
          <IndustryTile
            ...
            img="/assets/photos/marine-182646517.webp"
          />
          <IndustryTile
            ...
            img="/assets/photos/oilgas-71932049.webp"
          />
        </div>
