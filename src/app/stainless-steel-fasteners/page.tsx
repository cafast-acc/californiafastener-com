      ...
      <section className="ss-industries">
        <div className="ss-industries-inner">
          ...
          <div className="ss-industries-grid">
            ...
            <IndTile href="/industries/infrastructure" img={"/assets/photos/wastewater-treatment.jpg"} tag="304 · 316" eyebrow="04 — Wastewater" title={<>Municipal<br/>treatment plants.</>} desc="Clarifiers, headworks, UV systems. 316 for anything chlorinated; 304 acceptable in non-contact structural." />
            ...
            <IndTile href="/industries/power-generation" img={"/assets/photos/solar-wind.jpg"} tag="316 · Duplex" eyebrow="07 — Renewables" title={<>Solar & offshore<br/>wind hardware.</>} desc="Module clamps, rail hardware, foundation kits. Duplex becoming standard on offshore monopile grout connections." />
