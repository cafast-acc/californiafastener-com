      ...
      <section className="ss-industries">
        <div className="ss-industries-inner">
          ...
          <div className="ss-industries-grid">
            ...
            <IndTile href="/industries/power-transmission" img={INDUSTRIES["power-transmission"].heroImg} tag="316 · Duplex" eyebrow="08 — Power & utilities" title={<>Substation & coastal<br/>line hardware.</>} desc="Coastal substations and switchyards. 316 and duplex stand up to the salt fog and industrial atmospheres that strip galvanized carbon steel." />
          </div>
        </div>
      </section>
